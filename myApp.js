...
// **Note**: HyperDev is a real server, and in real servers interactions with
...
var removeManyPeople = function(done) {
  ...
  Person.remove({name: nameToRemove}, function(err, stats){
    if(err) return done(err);
    console.log(stats);
    done(null, stats);
  })
...
console.log(process.env.NODE_ENGINE)